...
#include "nav/parsers/xplane/AirwayParser.h"
...
AirwayLoader::AirwayLoader(XplaneNavDataLoader * mgr):
    loadMgr(mgr),
...
void AirwayLoader::onAirwayLoaded(const AirwayData& airway) {
    ...
    navdb::AirwayLevel level;
    switch (airway.level) {
    case AirwayData::AltitudeLevel::LOW:    level = navdb::AirwayLevel::LOWER; break;
    case AirwayData::AltitudeLevel::HIGH:   level = navdb::AirwayLevel::UPPER; break;
