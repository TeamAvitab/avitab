...
void FixLoader::addNDB(int id)
{
    ...
    navdb::RadioFrequency ndbFrq = navdb::RadioFrequency(freq, 0, navdb::RadioFrequency::Unit::KHZ, name);
...
void FixLoader::addVORDME(int id)
{
    ...
    navdb::RadioFrequency frequency = navdb::RadioFrequency(freq, 2, navdb::RadioFrequency::Unit::MHZ, name);
    if (!dme_only) {
